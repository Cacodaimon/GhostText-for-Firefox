...
var GhostTextMain = {
    ...
    /**
     * The log method will only print message if this flag is true.
     */
    verbose: false,
    ...
    setButtonStateByTab: function (tab, connected) {
        GhostTextMain.button.state('tab', {
            ...
            icon: {
                '18': connected ? './icon/18-on.png' : './icon/18.png', // toolbar icon non HiDPI
                '32': connected ? './icon/32-on.png' : './icon/32.png', // menu panel icon non HiDPI
                '36': connected ? './icon/36-on.png' : './icon/36.png', // toolbar icon HiDPI
                '64': connected ? './icon/64-on.png' : './icon/64.png'  // menu panel icon HiDPI
            }
        });
    },
    ...
    handleAjax: function (url, response) {
        GhostTextMain.log('Main.handleAjax');
    ...
    onMessageTab: function (message) {
        GhostTextMain.log(['Main.onMessageTab: ', JSON.stringify(message)]);
    ...
    onMessageBackground: function (message) {
        GhostTextMain.log(['Main.onMessageBackground: ', JSON.stringify(message)]);
    ...
    onTabClosedOrReloaded: function (tab) {
        GhostTextMain.log('Main.onTabClosedOrReloaded: ' + tab.id);
    ...
    injectScript: function (activeTab) {
        GhostTextMain.log('Main.injectScript ' + activeTab.id);
    ...
    handleClick: function () {
        GhostTextMain.log('Main.handleClick');
