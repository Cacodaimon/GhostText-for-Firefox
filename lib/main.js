 ...
 * @type {{browserTabs: Array, tabsWithScriptInjected: Array, backgroundPage: null, button: null, setButtonStateByTab: Function, handleAjax: Function, onMessageTab: Function, onMessageBackground: Function, injectScript: Function, handleClick: Function, init: Function}}
 */
GhostTextMain = {
    /**
     * Tab instances of connected tabs.
     */
    browserTabs: [],
    ...
    onMessageBackground: function (message) {
        ...
        switch (message.type) {
            case 'disable-field':
                var targetTab = GhostTextMain.browserTabs[message.tabId];
    ...
    handleClick: function() {
        ...
        if (!GhostTextMain.browserTabs[activeTab.id]) { //connect
